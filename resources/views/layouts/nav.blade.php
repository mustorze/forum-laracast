            ...
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @if (auth()->check())
                            <li><a href="{{ route('threads.by', auth()->user()->name) }}">My Threads</a></li>
                        @endif
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @foreach ($channels as $channel)
                            ...
                            <li><a href="{{ route('threads.channel.show', $channel->slug) }}">{{ $channel->name }}</a></li>
                ...
                @else
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li>
                                <a href="{{ route('profiles.show', auth()->user()->name) }}">My Profile</a>
                            </li>
